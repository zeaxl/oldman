...
<div class="page-wrapper">
   <div class="checkout shopping">
      <div class="container">
         <div class="row">
            <div class="col-md-8">
            <c:forEach items="${member}" var="m" end="0">
               <div class="block billing-details">
                  <h4 class="widget-title">Billing Details</h4>
                  <form class="checkout-form">
                     <div class="form-group">
                        <label for="full_name">Full Name</label>
                        <input type="text" class="form-control" id="full_name" value="${m.name}">
                     </div>
                     <div class="form-group">
                        <label for="user_address">Address</label>
                        <input type="text" class="form-control" id="user_address" value="${m.addr1}${m.addr2}">
                     </div>
                     <div class="checkout-country-code clearfix">
                        <div class="form-group">
                           <label for="user_post_code">Zip Code</label>
                           <input type="text" class="form-control" id="user_post_code" name="zipcode" value="${m.postcode}">
                        </div>
                        <div class="form-group" >
                  ...
                  <div class="block">
                     ...
                     <div class="media product-card">
                        ...
                        <div class="media-body">
                           ...
                           <p class="price"><input type="hidden" value="${o.pcount}" name="pcount" id="pcount">${o.pcount}</p>
                        </div>
                     </div>
