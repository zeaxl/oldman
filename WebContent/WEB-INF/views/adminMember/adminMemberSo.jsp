...
<div class="container-fluid">
 <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">일반 회원 </h1>
<p class="mb-4"> </p>
 <!-- DataTales Example -->
...
<select class="form-control  hidden-xs col-sm-12" id="list" name="list" onchange="location.href=this.value">
  ...
  <option value="${pageContext.request.contextPath}/admin/mem/so/1" selected>일반회원</option>
  <option value="${pageContext.request.contextPath}/admin/mem/do/1" >사업자회원</option>
 </select>
</div>
...
<c:when test="${m.mcode eq 'D' }">
	<td class="d-table-cell">사업자</td>
			...
			<a href="${pageContext.request.contextPath}/admin/mem/so/${paging.pageNo}/del/${m.mno}" onclick="return confirm('삭제하시겠습니까?');">
...
<ul class="pagination">
			...
			<a href="${pageContext.request.contextPath}/admin/mem/so/${paging.startPage - paging.pageSize}"
			...
			<a href="${pageContext.request.contextPath}/admin/mem/so/${pNo}" aria-controls="dataTable" data-dt-idx="0" tabindex="0" class="page-link">[${pNo}]</a>
			</li>
			</c:if>
		
			<c:if test="${pNo eq paging.pageNo}">	<li class="paginate_button page_item">
			<a href="${pageContext.request.contextPath}/admin/mem/so/${pNo}" style="color:red;" aria-controls="dataTable" data-dt-idx="0" tabindex="0" class="page-link">[${pNo}]</a>
			</li></c:if>
