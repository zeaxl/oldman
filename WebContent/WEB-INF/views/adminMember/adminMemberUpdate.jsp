...
<jsp:include page="../adminIndex/adminTopbar.jsp"></jsp:include>
 ...
 <form:form method="POST" commandName="memberVO" action="../${page.pageNo}/upd/ok" enctype="multipart/form-data">
...
<c:if test="${member.mcode eq 'D' }">
	...
	<label id = "la" for="inIt"><input type = "button" class="btn btn-primary"   id = "imgbtn" value = "첨 부"/></label></td></tr>
...
<input type="button" class="btn btn-primary" onclick="sample6_execDaumPostcode()" value="주소검색" ></td></tr>
<tr><td>
...
<td><form:input id="sample6_detailAddress" value="${member.addr2}" path="addr2" />
	...
	<td colspan="2">
<!-- 
	<a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="../upd/${member.mno}" >수정</a>
	<a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="../del/${member.mno}" >삭제</a></td>-->
	 <input type="submit" class="btn btn-primary" value="수정" />
		<input type="button" class="btn btn-primary" value="취소" onclick="location.href='../'" /></td> 
	</tr>
</table>
