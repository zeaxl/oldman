...
<script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/themefisher-font-style.css">
...
<!--  소매     -->
         ...
         <form:form action="/kherb/join/so" id = "soForm"  commandName ="memberVO" method="post">
         ...
         <div class="form-group" >
         <input type="button" value=" 중복  체크 "  class="btn btn-main btn-medium btn-round" onclick= "idCheck(this.id)" required="required">
         ...
         <div class="form-group">
         <input type="button" id = "emailChkButton_so" class="btn btn-main btn-medium btn-round" onclick="emailAuthfun()" value=" 인증 번호 ">
         </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
         <input type="button" class="btn btn-main btn-medium btn-round" onclick="sample4_execDaumPostcode_so()" value=" 우편 번호 "><br>
         ...
         <div class="form-group">
         <input type ="button" id="soJoinBtn" onclick="joinCheck(this.id)" class="btn btn-main btn-medium btn-round" value="회원가입"> <input class="btn btn-main btn-medium btn-round" type ="button" onclick="location.href='/kherb'" value="취소"> 
         </div>
         </form:form>
         </div>
<!--도매 -->
         ...
         <div class="form-group">
         <input type="button" value=" 중복 체크 "  class="btn btn-main btn-medium btn-round" id="doidCheck" onclick= "idCheck(this.id)" required="required">
         ...
         <div class="form-group">
         <input type="button" id = "emailChkButton_do" class="btn btn-main btn-medium btn-round" onclick="emailAuthfun()" value=" 인증 번호  ">
         </div>
         </div>
         <div class="form-group">
         <span class="emailCheckMessage_val"></span>
         ...
         <input type="text" id="sample4_postcode_do" class="form-control" name="postcode" value="${do_memberVO.postcode}" placeholder="우편번호" readonly ="readonly">
          ...
          <div class="form-group">
         <input type="button" class="btn btn-main btn-medium btn-round" onclick="sample4_execDaumPostcode_do()" value=" 우편 번호 "><br>
         ...
         <label id = "la" for="img2"><input type = "button" class="btn btn-main btn-medium btn-round" id = "imgbtn" value = " 첨부  파일 "/></label>
         </div>
         </div>
         <div class="form-group">
         <input type ="button" id="doJoinBtn" onclick="joinCheck(this.id)" class="btn btn-main btn-medium btn-round" value="회원가입"> <input class="btn btn-main btn-medium btn-round" type ="button" onclick="location.href='/kherb'" value="취소">
         </div>
         </form:form>
         
         </div>
          <p class="mt-20">Already hava an account ?<a href="login.html"> Login</a></p>
          <img src="${pageContext.request.contextPath}/resources/img/logo2.png" alt="KHerb" title="KHerb" width="20%" height="20%">
    ...
    <!-- Bootstrap Touchpin -->
    <script src="${pageContext.request.contextPath}/resources/plugins/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js"></script>
    <!-- Instagram Feed Js -->
    <script src="${pageContext.request.contextPath}/resources/plugins/instafeed/instafeed.min.js"></script>
    <!-- Video Lightbox Plugin -->
    <script src="${pageContext.request.contextPath}/resources/plugins/ekko-lightbox/dist/ekko-lightbox.min.js"></script>
    <!-- Count Down Js -->
    <script src="${pageContext.request.contextPath}/resources/plugins/syo-timer/build/jquery.syotimer.min.js"></script>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/plugins/google-map/gmap.js"></script>
